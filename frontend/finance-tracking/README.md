...
- Responsive dashboard across desktop/tablet/mobile breakpoints
- Empty states for no data scenarios
- Action notifications shown top-right for create/edit/delete/sign-in/sign-up

## Project Structure (Important Files)

- `src/pages/Dashboard.jsx` – main shell, nav state, role toggle
- `src/components/dashboard/MainDashBoard.jsx` – overview cards + charts + recent activity
- `src/components/dashboard/Transaction/` – transaction list/form/filter logic
- `src/components/dashboard/Insights.jsx` – analytics + explicit insight cards
